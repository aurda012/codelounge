  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      >
        {!readOnly && (
          <>
            ...
            <ToolbarGroup>
              ...
              <MarkToolbarButton tooltip="Inline Code" nodeType={MARK_CODE}>
                <Icons.code />
              </MarkToolbarButton>
              <MarkToolbarButton
                tooltip="Code Block"
                ...
                onClick={() =>
                  insertEmptyElement(editor, ELEMENT_CODE_BLOCK, {
                    select: true,
                    nextBlock: false,
                  })
                }
        ...
        <ToolbarGroup noSeparator>{/* <ModeDropdownMenu /> */}</ToolbarGroup>
      </div>
    </div>
  );
}
