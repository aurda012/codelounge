...
const Filters = ({
  ...
  return (
    <div
      className={`mt-8 flex flex-wrap-reverse gap-3 md:flex-wrap ${
        !jobFilter && "hidden"
      }`}
    >
      {filters.map((filter, index) => (
        <Button
          ...
          className={`body-medium mb-0.5 mr-0.5 rounded-lg px-6 py-2 capitalize shadow-none md:mb-0 md:mr-0 line-clamp-1 max-md:hidden ${
            active === filter.value
